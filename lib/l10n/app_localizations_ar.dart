...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get faqGeneralA1 => 'يراقب التطبيق استخدام جهازك في الوقت الفعلي، ويتتبع الوقت المستغرق في التطبيقات المختلفة. يوفر رؤى شاملة حول عاداتك الرقمية، بما في ذلك إجمالي وقت الشاشة والوقت المنتج واستخدام كل تطبيق.';

  @override
  String get faqGeneralQ2 => 'ما الذي يجعل التطبيق \'منتجاً\'؟';

  @override
  String get faqGeneralA2 => 'يمكنك تحديد التطبيقات كمنتجة يدوياً في قسم \'التطبيقات\'. تساهم التطبيقات المنتجة في نقاط الإنتاجية الخاصة بك، والتي تحسب نسبة وقت الشاشة المستغرق في التطبيقات المتعلقة بالعمل أو المفيدة.';

  @override
  String get faqGeneralQ3 => 'ما مدى دقة تتبع وقت الشاشة؟';

  @override
  String get faqGeneralA3 => 'يستخدم التطبيق التتبع على مستوى النظام لتوفير قياس دقيق لاستخدام جهازك. يلتقط وقت المقدمة لكل تطبيق مع تأثير ضئيل على البطارية.';

  @override
  String get faqGeneralQ4 => 'هل يمكنني تخصيص تصنيف التطبيقات؟';

  @override
  String get faqGeneralA4 => 'بالتأكيد! يمكنك إنشاء فئات مخصصة وتعيين التطبيقات لفئات محددة وتعديل هذه التعيينات بسهولة في قسم \'التطبيقات\'. يساعد هذا في إنشاء تحليلات استخدام أكثر فائدة.';

  @override
  String get faqGeneralQ5 => 'ما الرؤى التي يمكنني الحصول عليها من هذا التطبيق؟';

  @override
  String get faqGeneralA5 => 'يقدم التطبيق رؤى شاملة تشمل نقاط الإنتاجية وأنماط الاستخدام حسب الوقت من اليوم واستخدام التطبيقات التفصيلي وتتبع جلسات التركيز والتحليلات المرئية مثل الرسوم البيانية والمخططات الدائرية لمساعدتك على فهم وتحسين عاداتك الرقمية.';
  ...
  @override
  String get faqAppsA2 => 'نعم، يتضمن قسم التطبيقات وظيفة البحث وخيارات التصفية. يمكنك تصفية التطبيقات حسب الفئة وحالة الإنتاجية وحالة التتبع والرؤية.';

  @override
  String get faqAppsQ3 => 'ما خيارات التحرير المتاحة للتطبيقات؟';

  @override
  String get faqAppsA3 => 'لكل تطبيق، يمكنك تحرير: تعيين الفئة وحالة الإنتاجية وتتبع الاستخدام والرؤية في التقارير وتعيين حدود زمنية يومية فردية.';

  @override
  String get faqAppsQ4 => 'كيف يتم تحديد فئات التطبيقات؟';

  @override
  String get faqAppsA4 => 'الفئات الأولية مقترحة من النظام، لكن لديك السيطرة الكاملة لإنشاء وتعديل وتعيين فئات مخصصة بناءً على سير عملك وتفضيلاتك.';

  @override
  String get faqReportsQ1 => 'ما أنواع التقارير المتاحة؟';

  @override
  String get faqReportsA1 => 'تشمل التقارير: إجمالي وقت الشاشة، الوقت المنتج، التطبيقات الأكثر استخداماً، جلسات التركيز، رسم بياني لوقت الشاشة اليومي، مخطط دائري لتوزيع الفئات، استخدام التطبيقات التفصيلي، اتجاهات الاستخدام الأسبوعية، وتحليل أنماط الاستخدام حسب الوقت من اليوم.';

  @override
  String get faqReportsQ2 => 'ما مدى تفصيل تقارير استخدام التطبيقات؟';

  @override
  String get faqReportsA2 => 'تعرض تقارير استخدام التطبيقات التفصيلية: اسم التطبيق والفئة وإجمالي الوقت المستغرق وحالة الإنتاجية، وتوفر قسم \'الإجراءات\' مع رؤى أعمق مثل ملخص الاستخدام والحدود اليومية واتجاهات الاستخدام ومقاييس الإنتاجية.';

  @override
  String get faqReportsQ3 => 'هل يمكنني تحليل اتجاهات الاستخدام بمرور الوقت؟';

  @override
  String get faqReportsA3 => 'نعم! يوفر التطبيق مقارنات أسبوعية، تعرض رسوماً بيانية للاستخدام على مدى الأسابيع الماضية ومتوسط الاستخدام اليومي وأطول الجلسات والإجماليات الأسبوعية لمساعدتك على تتبع عاداتك الرقمية.';

  @override
  String get faqReportsQ4 => 'ما هو تحليل \'نمط الاستخدام\'؟';

  @override
  String get faqReportsA4 => 'يقسم نمط الاستخدام وقت الشاشة إلى فترات الصباح والظهر والمساء والليل. يساعدك هذا على فهم متى تكون أكثر نشاطاً على جهازك وتحديد المجالات المحتملة للتحسين.';

  @override
  String get faqAlertsQ1 => 'ما مدى دقة حدود وقت الشاشة؟';

  @override
  String get faqAlertsA1 => 'يمكنك تعيين حدود يومية إجمالية لوقت الشاشة وحدود فردية للتطبيقات. يمكن تكوين الحدود بالساعات والدقائق، مع خيارات لإعادة التعيين أو التعديل حسب الحاجة.';

  @override
  String get faqAlertsQ2 => 'ما خيارات الإشعارات المتاحة؟';

  @override
  String get faqAlertsA2 => 'يقدم التطبيق أنواعاً متعددة من الإشعارات: تنبيهات النظام عند تجاوز وقت الشاشة، تنبيهات متكررة بفترات قابلة للتخصيص (1 أو 5 أو 15 أو 30 أو 60 دقيقة)، ومفاتيح تبديل لوضع التركيز ووقت الشاشة والإشعارات الخاصة بالتطبيقات.';

  @override
  String get faqAlertsQ3 => 'هل يمكنني تخصيص تنبيهات الحدود؟';

  @override
  String get faqAlertsA3 => 'نعم، يمكنك تخصيص تردد التنبيهات وتمكين/تعطيل أنواع محددة من التنبيهات وتعيين حدود مختلفة لوقت الشاشة الإجمالي والتطبيقات الفردية.';

  @override
  String get faqFocusQ1 => 'ما أنواع أوضاع التركيز المتاحة؟';

  @override
  String get faqFocusA1 => 'تشمل الأوضاع المتاحة العمل العميق (جلسات تركيز أطول) والمهام السريعة (فترات عمل قصيرة) ووضع القراءة. يساعدك كل وضع على هيكلة عملك وأوقات الراحة بفعالية.';

  @override
  String get faqFocusQ2 => 'ما مدى مرونة مؤقت بومودورو؟';

  @override
  String get faqFocusA2 => 'المؤقت قابل للتخصيص بدرجة عالية. يمكنك ضبط مدة العمل وطول الاستراحة القصيرة ومدة الاستراحة الطويلة. تشمل الخيارات الإضافية البدء التلقائي للجلسات التالية وإعدادات الإشعارات.';

  @override
  String get faqFocusQ3 => 'ماذا يظهر سجل وضع التركيز؟';

  @override
  String get faqFocusA3 => 'يتتبع سجل وضع التركيز جلسات التركيز اليومية، ويعرض عدد الجلسات في اليوم ورسم بياني للاتجاهات ومتوسط مدة الجلسة وإجمالي وقت التركيز ومخطط دائري لتوزيع الوقت يقسم جلسات العمل والاستراحات القصيرة والاستراحات الطويلة.';

  @override
  String get faqFocusQ4 => 'هل يمكنني تتبع تقدم جلسة التركيز؟';

  @override
  String get faqFocusA4 => 'يتميز التطبيق بواجهة مؤقت دائرية مع أزرار التشغيل/الإيقاف وإعادة التحميل والإعدادات. يمكنك بسهولة تتبع وإدارة جلسات التركيز بعناصر تحكم بديهية.';

  @override
  String get faqSettingsQ1 => 'ما خيارات التخصيص المتاحة؟';

  @override
  String get faqSettingsA1 => 'يشمل التخصيص اختيار السمة (النظام، فاتح، داكن) وإعدادات اللغة وسلوك بدء التشغيل وعناصر تحكم شاملة في الإشعارات وخيارات إدارة البيانات مثل مسح البيانات أو إعادة تعيين الإعدادات.';

  @override
  String get faqSettingsQ2 => 'كيف أقدم ملاحظات أو أبلغ عن مشاكل؟';

  @override
  String get faqSettingsA2 => 'في أسفل قسم الإعدادات، ستجد أزراراً للإبلاغ عن خطأ أو إرسال ملاحظات أو الاتصال بالدعم. ستوجهك هذه إلى قنوات الدعم المناسبة.';

  @override
  String get faqSettingsQ3 => 'ماذا يحدث عند مسح البيانات؟';

  @override
  String get faqSettingsA3 => 'سيؤدي مسح البيانات إلى إعادة تعيين جميع إحصائيات الاستخدام وسجل جلسات التركيز والإعدادات المخصصة. هذا مفيد للبدء من جديد أو استكشاف الأخطاء وإصلاحها.';

  @override
  String get faqTroubleQ1 => 'البيانات لا تظهر، خطأ عدم فتح hive';

  @override
  String get faqTroubleA1 => 'المشكلة معروفة، الحل المؤقت هو مسح البيانات من خلال الإعدادات وإذا لم ينجح ذلك فانتقل إلى المستندات واحذف الملفات التالية إذا كانت موجودة - harman_screentime_app_usage_box.hive و harman_screentime_app_usage.lock، يُنصح أيضاً بتحديث التطبيق إلى أحدث إصدار.';

  @override
  String get faqTroubleQ2 => 'التطبيق يفتح عند كل بدء تشغيل، ماذا أفعل؟';

  @override
  String get faqTroubleA2 => 'هذه مشكلة معروفة تحدث في ويندوز 10، الحل المؤقت هو تمكين التشغيل كمصغر في الإعدادات حتى يتم تشغيله كمصغر.';
  ...
  @override
  String get failedToInitialize => 'فشل في تهيئة التحليلات. يرجى إعادة تشغيل التطبيق.';
  ...
  @override
  String get startDateBeforeEndDate => 'يجب أن يكون تاريخ البداية قبل أو يساوي تاريخ النهاية.';
  ...
  @override
  String get trendingUpward => 'استخدامك يتجه نحو الارتفاع مقارنة بالفترة السابقة.';
  ...
  @override
  String get trendingDownward => 'استخدامك يتجه نحو الانخفاض مقارنة بالفترة السابقة.';
  ...
  @override
  String get markedAsNonProductive => 'هذا مُعلَّم كتطبيق غير منتج في إعداداتك.';
  ...
  @override
  String get resetSettingsContent => 'إذا قمت بإعادة تعيين الإعدادات، لن تتمكن من استعادتها. هل تريد إعادة التعيين؟';
  ...
  @override
  String get startUsingApplications => 'ابدأ باستخدام تطبيقاتك لتتبع وقت الشاشة والإنتاجية.';
  ...
  @override
  String get noAppUsageDataAvailable => 'لا توجد بيانات استخدام التطبيقات متاحة بعد';
  ...
  @override
  String get launchMinimizedDescription => 'بدء التطبيق في شريط النظام (موصى به لويندوز 10)';
  ...
  @override
  String get screenTimeNotificationsDescription => 'جميع إشعارات تقييد وقت الشاشة';

  @override
  String get appScreenTimeNotificationsTitle => 'وقت شاشة التطبيق';

  @override
  String get appScreenTimeNotificationsDescription => 'جميع إشعارات تقييد وقت شاشة التطبيق';

  @override
  String get frequentAlertsTitle => 'فترة التنبيهات المتكررة';

  @override
  String get frequentAlertsDescription => 'تعيين فترة الإشعارات المتكررة (بالدقائق)';
  ...
  @override
  String get clearDataDialogContent => 'سيؤدي هذا إلى مسح جميع السجلات والبيانات ذات الصلة. لن تتمكن من استعادتها. هل تريد المتابعة؟';
  ...
  @override
  String get resetSettingsDialogContent => 'سيؤدي هذا إلى إعادة تعيين جميع الإعدادات إلى قيمها الافتراضية. هل تريد المتابعة؟';
  ...
  @override
  String get replaceWarningMessage => 'سيؤدي هذا إلى استبدال جميع بياناتك الموجودة. هل أنت متأكد أنك تريد المتابعة؟';
  ...
  @override
  String get faqSettingsA4 => 'يمكنك الذهاب إلى الإعدادات، وهناك ستجد قسم النسخ الاحتياطي والاستعادة. يمكنك تصدير أو استيراد البيانات من هنا، لاحظ أن ملف البيانات المصدّر يتم تخزينه في المستندات في مجلد Scolect-Backups ويمكن استخدام هذا الملف فقط لاستعادة البيانات، ولا يمكن استخدام أي ملف آخر.';

  @override
  String get faqGeneralQ6 => 'كيف يمكنني تغيير اللغة وما اللغات المتاحة، وماذا لو وجدت أن الترجمة خاطئة؟';
  ...
  @override
  String get faqGeneralA7 => 'قد تكون الترجمة خاطئة لأنها مُولّدة بالذكاء الاصطناعي من الإنجليزية وإذا كنت تريد الإبلاغ فيمكنك الإبلاغ من خلال الإبلاغ عن خطأ أو اتصل بنا، أو إذا كنت مطوراً يمكنك فتح مشكلة على جيت هب. المساهمات المتعلقة باللغة مرحب بها أيضاً!';
  ...
  @override
  String get advancedWarning => 'قد تزيد الميزات المتقدمة من استخدام الموارد. قم بالتمكين فقط إذا لزم الأمر.';
  ...
  @override
  String get monitorHIDDescription => 'اكتشاف عجلات القيادة والأجهزة اللوحية والأجهزة المخصصة';

  @override
  String get setIdleTimeoutTitle => 'تعيين مهلة الخمول';

  @override
  String get idleTimeoutDialogDescription => 'اختر المدة التي يجب الانتظار قبل اعتبارك خاملاً:';
  ...
  @override
  String get alertsLimitsSubtitle => 'إدارة حدود وقت الشاشة والإشعارات الخاصة بك';
  ...
  @override
  String get notification_permission_denied_message => 'يحتاج ScreenTime إلى إذن الإشعار لإرسال التنبيهات والتذكيرات.\n\nهل تريد فتح إعدادات النظام لتمكين الإشعارات؟';

  @override
  String get notification_permission_denied_hint => 'افتح إعدادات النظام لتمكين إشعارات ScreenTime.';

  @override
  String get notification_permission_required => 'مطلوب إذن الإشعار';

  @override
  String get notification_permission_required_message => 'يحتاج ScreenTime إلى إذن لإرسال الإشعارات إليك.';
  ...
  @override
  String get enable_notification_permission_hint => 'قم بتمكين إذن الإشعار لتلقي التنبيهات';
  ...
  @override
  String get systemNotificationsDisabled => 'تم تعطيل إشعارات النظام. قم بتمكينها في إعدادات النظام لتنبيهات التركيز.';

  @override
  String get openSystemSettings => 'فتح إعدادات النظام';

  @override
  String get appNotificationsDisabled => 'تم تعطيل الإشعارات في إعدادات التطبيق. قم بتمكينها لتلقي تنبيهات التركيز.';

  @override
  String get goToSettings => 'الانتقال إلى الإعدادات';

  @override
  String get focusModeNotificationsDisabled => 'تم تعطيل إشعارات وضع التركيز. قم بتمكينها لتلقي تنبيهات الجلسة.';
  ...
  @override
  String get notificationsDisabledSystemLevel => 'تم تعطيل الإشعارات على مستوى النظام. للتمكين:';

  @override
  String get step1OpenSystemSettings => '1. افتح إعدادات النظام (تفضيلات النظام)';
  ...
  @override
  String get primaryColorsDesc => 'ألوان التمييز الرئيسية المستخدمة في جميع أنحاء التطبيق';

  @override
  String get primaryAccent => 'التمييز الأساسي';

  @override
  String get primaryAccentDesc => 'لون العلامة التجارية الرئيسي، الأزرار، الروابط';
  ...
  @override
  String get launchAtStartupDescription => 'بدء Scolect تلقائيًا عند تسجيل الدخول إلى جهاز الكمبيوتر الخاص بك';

  @override
  String get inputMonitoringPermissionTitle => 'مراقبة لوحة المفاتيح غير متاحة';

  @override
  String get inputMonitoringPermissionDescription => 'يرجى تمكين إذن مراقبة الإدخال لتتبع نشاط لوحة المفاتيح. يتم حاليًا مراقبة إدخال الماوس فقط.';
  ...
  @override
  String get permissionGrantedDescription => 'يجب إعادة تشغيل التطبيق لتفعيل مراقبة الإدخال.';
  ...
  @override
  String get restartRequiredDescription => 'لتفعيل مراقبة لوحة المفاتيح، يجب إعادة تشغيل التطبيق. هذا مطلوب من قبل macOS.';

  @override
  String get restartNote => 'سيتم إعادة تشغيل التطبيق تلقائيًا بعد إعادة التشغيل.';
  ...
  @override
  String get restartFailedMessage => 'تعذر إعادة تشغيل التطبيق تلقائيًا. يرجى الخروج (Cmd+Q) وإعادة تشغيله يدويًا.';
  ...
  @override
  String get beautifulExcelReportDescription => 'جدول بيانات ملون وجميل مع رسوم بيانية ورموز تعبيرية ورؤى ✨';

  @override
  String get excelReportIncludes => 'يتضمن تقرير الإكسل:';

  @override
  String get summarySheetDescription => '📊 ورقة الملخص - المقاييس الرئيسية مع الاتجاهات';

  @override
  String get dailyBreakdownDescription => '📅 التفصيل اليومي - أنماط الاستخدام المرئية';

  @override
  String get appsSheetDescription => '📱 ورقة التطبيقات - تصنيفات التطبيقات التفصيلية';

  @override
  String get insightsDescription => '💡 رؤى - توصيات ذكية';

  @override
  String get beautifulExcelExportSuccess => 'تم تصدير تقرير الإكسل الجميل بنجاح! 🎉';
  ...
  @override
  String get insightNoFocusSessions => 'لا توجد جلسات تركيز: فكر في استخدام وضع التركيز لتعزيز إنتاجيتك';
  ...
  @override
  String get recScheduleFocusSessions => 'حاول جدولة المزيد من جلسات التركيز طوال يومك لتعزيز الإنتاجية';

  @override
  String get recSetAppLimits => 'فكر في وضع حدود على تطبيقات الترفيه';

  @override
  String get recAimForFocusSessions => 'اهدف إلى 1-2 جلسة تركيز على الأقل يومياً لبناء عادة ثابتة';

  @override
  String get recTakeBreaks => 'وقت شاشتك اليومي مرتفع جداً. حاول أخذ فترات راحة منتظمة باستخدام قاعدة 20-20-20';

  @override
  String get recSetDailyGoals => 'فكر في تحديد أهداف يومية لوقت الشاشة لتقليل الاستخدام تدريجياً';

  @override
  String get recBalanceEntertainment => 'تطبيقات الترفيه تستهلك جزءاً كبيراً من وقتك. فكر في التوازن مع أنشطة أكثر إنتاجية';

  @override
  String get recReviewUsagePatterns => 'زاد وقت شاشتك بشكل كبير. راجع أنماط استخدامك وضع حدوداً';

  @override
  String get recScheduleFocusedWork => 'انخفض وقتك المنتج. حاول جدولة فترات عمل مركزة في تقويمك';

  @override
  String get recKeepUpGreatWork => 'واصل العمل الرائع! عادات وقت الشاشة لديك تبدو صحية';

  @override
  String get recContinueFocusSessions => 'استمر في استخدام جلسات التركيز للحفاظ على الإنتاجية';
  ...
  @override
  String get shareThemeViaSystemSheet => 'مشاركة السمة باستخدام ورقة المشاركة للنظام';
  ...
  @override
  String get importFromClipboardJSON => 'استيراد السمة من بيانات JSON في الحافظة';
  ...
  @override
  String get invalidThemeFormat => 'تنسيق السمة غير صالح. يرجى التحقق من بيانات JSON.';
  ...
  @override
  String get trackingModePreciseHint => 'تتبع في الوقت الفعلي - دقة أعلى، موارد أكثر';

  @override
  String get trackingModeChangeError => 'فشل في تغيير وضع التتبع. يرجى المحاولة مرة أخرى.';
  ...
  @override
  String get monitorKeyboardDescription => 'تتبع نشاط لوحة المفاتيح لاكتشاف وجود المستخدم';
  ...
  @override
  String get changelogErrorDescription => 'تعذر استرداد سجل التغييرات لهذا الإصدار. يرجى التحقق من اتصالك بالإنترنت أو زيارة صفحة الإصدارات على GitHub.';
