...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get browserExtensionTitle => 'امتداد المتصفح';

  @override
  String get browserExtensionDescription =>
      'السماح لامتداد متصفح Scolect بالاتصال ومزامنة بيانات استخدام المواقع';
  ...
  String narrativeTodaySpent(String timeStr) {
    return 'قضيت اليوم $timeStr على حاسوبك.';
  }

  @override
  String narrativeMostFocused(String start, String end) {
    return 'فترة تركيزك القصوى كانت من $start – $end.';
  }
  ...
  String narrativeFocusSessions(
    ...
    return 'أكملت $focusSessions $_temp0 تركيز بإجمالي ${fsMinutes}m.';
  }

  @override
  String narrativeCheckedAppShort(String topAppName, int topAppOpenCount) {
    return 'تفقدت $topAppName $topAppOpenCount مرات ولكنك أبقيت كل زيارة قصيرة.';
  }
  ...
  String narrativeCheckedAppLong(
    ...
    return 'معظم وقتك على $topAppName كان في $topAppOpenCount $_temp0 فقط.';
  }

  @override
  String get narrativeToneSolid => 'يوم ممتاز.';

  @override
  String get narrativeToneDecent => 'تقدم جيد.';

  @override
  String get narrativeToneLight => 'يوم خفيف — لا بأس بذلك.';

  @override
  String get narrativeToneImprove => 'هناك مجال للتحسن غدًا.';

  @override
  String get habitDnaTitle => 'الحمض النووي لعاداتك';

  @override
  String habitDnaAnalyzed(int daysAnalyzed) {
    return 'تم تحليل $daysAnalyzed يوماً';
  }

  @override
  String get habitDnaChronotype => 'النمط الزمني';

  @override
  String get habitDnaWorkStyle => 'أسلوب العمل';

  @override
  String get habitDnaPeakFocus => 'ذروة التركيز';

  @override
  String get habitDnaAvgSession => 'متوسط الجلسة';

  @override
  String get habitDnaBestDay => 'أفضل يوم';

  @override
  String get habitDnaRoughDay => 'يوم صعب';

  @override
  String habitDnaKryptonite(String appName) {
    return 'أكبر مصدر تشتيت: $appName';
  }

  @override
  String get chronotypeMorning => 'شخص صباحي';

  @override
  String get chronotypeAfternoon => 'نشاط مسائي';

  @override
  String get chronotypeNight => 'بومة الليل';

  @override
  String get chronotypeMixed => 'مختلط';

  @override
  String get workStyleDeep => 'تركيز عميق';

  @override
  String get workStyleSwitcher => 'متنقل بين المهام';
  ...
  @override
  String get timeFormatMidnight => 'منتصف الليل';

  @override
  String get timeFormatNoon => 'الظهر';

  @override
  String get weeklyStoryTitle => 'هذا الأسبوع';
  ...
  String weeklyStoryHeadline(int weekNumber, String timeStr) {
    return 'الأسبوع $weekNumber — $timeStr على الشاشة حتى الآن.';
  }

  @override
  String weeklyStoryReclaimed(String diff) {
    return 'لقد استعدت $diff مقارنة بالأسبوع 1.';
  }

  @override
  String weeklyStoryUp(String diff) {
    return 'وقت الشاشة زاد بمقدار $diff مقارنة بالأسبوع 1.';
  }

  @override
  String weeklyStoryImprovementArea(String timeLabel, String worstCat) {
    return 'لا يزال العمل جارياً على: $timeLabel في $worstCat.';
  }

  @override
  String get weekdayNameMonday => 'الاثنين';

  @override
  String get weekdayNameTuesday => 'الثلاثاء';

  @override
  String get weekdayNameWednesday => 'الأربعاء';

  @override
  String get weekdayNameThursday => 'الخميس';

  @override
  String get weekdayNameFriday => 'الجمعة';

  @override
  String get weekdayNameSaturday => 'السبت';

  @override
  String get weekdayNameSunday => 'الأحد';

  @override
  String get weekdayNameUnknown => 'ذلك اليوم';

  @override
  String get browserTitle => 'المتصفح';

  @override
  String get browserWebsiteTracking => 'تتبع المواقع';

  @override
  String get browserSubtitle => 'تتبع استخدامك للمواقع وإدارته';

  @override
  String get browserToday => 'اليوم';
  ...
  @override
  String get browserSyncing => 'جارٍ المزامنة';

  @override
  String get browserTabOverview => 'نظرة عامة';

  @override
  String get browserTabWebsites => 'المواقع';

  @override
  String get browserTabCategories => 'الفئات';

  @override
  String get browserTabLimits => 'الحدود';

  @override
  String get browserTabHistory => 'السجل';

  @override
  String get browserHistoryTitle => 'نظرة أسبوعية';

  @override
  String get browserHistorySubtitle => 'وقت تصفحك خلال الأيام السبعة الماضية';

  @override
  String get browserHistoryNoData => 'لا توجد بيانات تصفح بعد';

  @override
  String get browserHistoryAvgPerDay => 'المتوسط / يوم';

  @override
  String get browserHistoryPeakDay => 'ذروة اليوم';

  @override
  String get browserHistoryTotalWeek => 'إجمالي هذا الأسبوع';

  @override
  String get browserHistoryTopSites => 'أكثر المواقع زيارةً هذا الأسبوع';

  @override
  String get browserTodayWebTime => 'وقت الويب اليوم';

  @override
  String get browserSitesVisited => 'المواقع المُزارة';

  @override
  String get browserPageVisits => 'زيارات الصفحات';

  @override
  String get browserTopSitesToday => 'أكثر المواقع زيارةً اليوم';

  @override
  String get browserViewAll => 'عرض الكل →';

  @override
  String get browserNoWebActivityTitle => 'لا نشاط على الويب اليوم بعد';

  @override
  String get browserNoActivityWebSubtitle => 'تصفح الويب لبدء تتبع وقتك';

  @override
  String get browserNoActivityDesktopSubtitle =>
      'ثبّت امتداد المتصفح لبدء التتبع';

  @override
  String get browserNoCategoriesTitle => 'لا توجد فئات بعد';

  @override
  String get browserNoCategoriesSubtitle => 'تظهر الفئات بعد تتبع المواقع';

  @override
  String get browserByCategory => 'حسب الفئة';
  ...
  @override
  String get browserSearchPlaceholder => 'ابحث عن موقع أو نطاق…';

  @override
  String get browserFilterAllTracking => 'جميع التتبع';

  @override
  String get browserFilterTracked => 'مُتتبَّع';

  @override
  String get browserFilterUntracked => 'غير مُتتبَّع';

  @override
  String get browserFilterAllTypes => 'جميع الأنواع';

  @override
  String get browserFilterUnproductive => 'غير منتج';
  ...
  @override
  String get browserColumnDomain => 'النطاق';

  @override
  String get browserColumnTimeToday => 'الوقت اليوم';

  @override
  String get browserColumnVisits => 'الزيارات';

  @override
  String get browserColumnTracking => 'التتبع';

  @override
  String get browserNoWebsitesTitle => 'لا توجد مواقع';

  @override
  String get browserNoWebsitesWebSubtitle => 'تصفح الويب — ستظهر مواقعك هنا.';

  @override
  String get browserNoWebsitesDesktopSubtitle =>
      'حاول تعديل الفلاتر أو انتظر حتى\nتزامن الامتداد بعض البيانات.';

  @override
  String get browserTimeDistribution => 'توزيع الوقت';
  ...
  @override
  String get browserActiveLimits => 'الحدود النشطة';
  ...
  String browserActiveLimitsSubtitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count موقع بحدود يومية',
      one: 'موقع واحد بحدود يومية',
    );
    return '$_temp0';
  }

  @override
  String get browserNoLimitsTitle => 'لم يتم تعيين حدود';

  @override
  String get browserNoLimitsSubtitle => 'اضبط الحدود اليومية للوقت أدناه';

  @override
  String get browserAllWebsites => 'جميع المواقع';

  @override
  String get browserAllWebsitesSubtitle =>
      'اضغط على موقع لتعيين حده اليومي أو تغييره';

  @override
  String get browserAllSitesHaveLimits => 'جميع المواقع لديها حدود';

  @override
  String get browserNoWebsitesTrackedTitle => 'لا توجد مواقع مُتتبَّعة بعد';

  @override
  String get browserNoWebsitesTrackedWebSubtitle =>
      'تصفح الويب لرؤية مواقعك هنا';

  @override
  String get browserNoWebsitesTrackedDesktopSubtitle =>
      'ثبّت الامتداد وابدأ التصفح للبدء';

  @override
  String browserDailyLimitDialog(String domain) {
    return 'الحد اليومي – $domain';
  }

  @override
  String get browserDailyLimitDialogDesc =>
      'اضبط المدة التي يمكنك فيها زيارة هذا الموقع يومياً.';

  @override
  String get browserHours => 'ساعات';

  @override
  String get browserRemoveLimit => 'إزالة الحد';
  ...
  @override
  String get browserSetLimit => 'تعيين الحد';

  @override
  String get browserExtensionMode => 'وضع الامتداد';

  @override
  String get browserDesktopAppUrl => 'عنوان URL لتطبيق سطح المكتب';

  @override
  String get browserDesktopAppUrlDesc =>
      'عنوان URL حيث يعمل تطبيق Scolect لسطح المكتب على خادمه المحلي.';

  @override
  String get browserAbout => 'حول';

  @override
  String get browserAboutExtension => 'الامتداد';

  @override
  String get browserAboutExtensionValue => 'Scolect – Web Time Tracker';

  @override
  String get browserAboutVersion => 'الإصدار';

  @override
  String get browserAboutStorage => 'التخزين';

  @override
  String get browserAboutStorageValue => 'chrome.storage.local';

  @override
  String get browserAboutHistory => 'السجل';
  ...
  @override
  String get browserSourcePingTooltip => 'تحديد موقع / إرسال إشعار للمتصفح';

  @override
  String browserSourcePingSent(String name) {
    return 'تم إرسال الإشعار إلى $name';
  }
  ...
  @override
  String get browserLimitsScopeTitle => 'نطاق حدود المواقع';

  @override
  String get browserLimitsScopeSubtitle =>
      'اختر ما إذا كانت حدود المواقع والتتبع تنطبق على كل ملف تعريف متصفح أو عالميًا عبر جميع المتصفحات.';

  @override
  String get browserLimitsScopeScoped => 'لكل ملف تعريف متصفح (مخصص)';

  @override
  String get browserLimitsScopeScopedDesc =>
      'تنطبق الحدود فقط على ملف تعريف المتصفح المحدد الذي تم تكوينه فيه.';

  @override
  String get browserLimitsScopeGlobal => 'شامل (عبر جميع المتصفحات)';

  @override
  String get browserLimitsScopeGlobalDesc =>
      'تنطبق الحدود على جميع المتصفحات المتصلة مجتمعة.';
  ...
  @override
  String get browserClearDataTitle => 'مسح جميع بيانات المواقع';

  @override
  String get browserClearDataDesc =>
      'يحذف نهائياً جميع سجلات المواقع المُتتبَّعة. لا يمكن التراجع عن هذا.';

  @override
  String get browserClearDataButton => 'مسح البيانات';

  @override
  String get browserAreYouSure => 'هل أنت متأكد؟';

  @override
  String get browserYesDelete => 'نعم، احذف';

  @override
  String get browserDesktopUrlSaved => 'تم حفظ عنوان URL لسطح المكتب';

  @override
  String get browserDataCleared => 'تم مسح جميع بيانات المواقع';

  @override
  String get browserTrackingActive => 'التتبع نشط';

  @override
  String get browserTrackingActiveDesc =>
      'يتم تتبع نشاط متصفحك ومزامنته\nمع تطبيق Scolect لسطح المكتب.';

  @override
  String get browserConnectedToDesktop => 'متصل بـ Scolect Desktop';

  @override
  String get browserDesktopNotReachable => 'Scolect Desktop غير متاح';

  @override
  String get browserRefreshSyncStatus => 'تحديث حالة المزامنة';

  @override
  String get browserSwitchToStandalone => 'التبديل إلى وضع مستقل →';

  @override
  String get browserSetupTitle => 'ربط امتداد المتصفح';

  @override
  String get browserSetupSubtitle =>
      'فعّل الخادم المحلي حتى يتمكن امتداد متصفح Scolect من مزامنة نشاطك على الويب مع تطبيق سطح المكتب.';

  @override
  String get browserSetupEnableServer => 'تفعيل خادم الامتداد';

  @override
  String browserSetupServerRunning(int port) {
    return 'الخادم يعمل · المنفذ $port';
  }

  @override
  String get browserSetupServerOff => 'الخادم معطّل';

  @override
  String get browserSetupStep1 => 'فعّل الخادم باستخدام الزر أعلاه';

  @override
  String get browserSetupStep2 => 'ثبّت امتداد Scolect في متصفحك';

  @override
  String get browserSetupStep3 => 'افتح متصفحك وزر أي موقع';

  @override
  String get browserSetupStep4 => 'سيظهر نشاط الويب هنا تلقائياً';

  @override
  String get browserSetupHowTo => 'كيفية البدء';

  @override
  String get browserSetupServerActive => 'الخادم نشط';

  @override
  String get browserSetupServerActiveDesc =>
      'يمكن لامتداد المتصفح الآن الاتصال ومزامنة البيانات.';

  @override
  String get browserSyncedJustNow => 'تمت المزامنة للتو';

  @override
  String browserSyncedMinutesAgo(int minutes) {
    return 'تمت المزامنة منذ $minutes دقيقة';
  }

  @override
  String browserSyncedHoursAgo(int hours) {
    return 'تمت المزامنة منذ $hours ساعة';
  }

  @override
  String get browserNeverSynced => 'لم تتم المزامنة بعد';

  @override
  String get browserSyncStalled => 'توقفت المزامنة — تحقق من الإضافة';

  @override
  String get browserServerPort => 'منفذ الخادم';

  @override
  String get browserServerPortDesc =>
      'المنفذ الذي يستمع إليه الخادم المحلي. غيّره إذا كان المنفذ 46000 قيد الاستخدام بالفعل.';

  @override
  String get browserServerPortSaved =>
      'تم تحديث المنفذ — جارٍ إعادة اتصال الامتداد';
  ...
  @override
  String get privateModeLockHint => 'انقر بزر الماوس الأيمن للقفل الآن';

  @override
  String get privateModeShowOnlyDescription =>
      'إظهار التطبيقات والمواقع المحددة كخاصة فقط، بدلاً من العرض اليومي. متاح أيضًا من شريط العناوين.';
  ...
  @override
  String get privateModeForgotPassword => 'هل نسيت كلمة المرور؟';

  @override
  String get privateModeRecoveryTitle => 'استعادة الوضع الخاص';

  @override
  String get privateModeRecoveryTabBackupCode => 'رمز النسخ الاحتياطي';

  @override
  String get privateModeRecoveryTabSecurityQuestion => 'سؤال الأمان';

  @override
  String get privateModeBackupCodePlaceholder => 'XXXX-XXXX-XXXX-XXXX';

  @override
  String get privateModeSecurityAnswerPlaceholder => 'إجابتك';

  @override
  String get privateModeRecoveryIncorrect =>
      'لم يتطابق ذلك. يرجى المحاولة مرة أخرى.';

  @override
  String get privateModeRecoverySuccessTitle => 'تم التحقق من الهوية';

  @override
  String get privateModeRecoverySuccessDescription =>
      'تم مسح كلمة المرور القديمة. قم بتعيين كلمة مرور جديدة للمتابعة — ستحصل أيضًا على رمز نسخ احتياطي وسؤال أمان جديدين.';

  @override
  String get privateModeSetupRecoveryTitle => 'إعداد الاسترداد';

  @override
  String get privateModeBackupCodeGeneratedTitle =>
      'رمز النسخ الاحتياطي الخاص بك';

  @override
  String get privateModeBackupCodeWarning =>
      'احفظ هذا الرمز في مكان آمن. سيتم عرضه مرة واحدة فقط، وستحتاجه إذا نسيت كلمة المرور الخاصة بك.';

  @override
  String get privateModeCopyBackupCode => 'نسخ';

  @override
  String get privateModeBackupCodeCopied => 'تم نسخ رمز النسخ الاحتياطي';

  @override
  String get privateModeDownloadBackupCode => 'تنزيل';

  @override
  String get privateModeSecurityQuestionLabel => 'سؤال الأمان';

  @override
  String get privateModeSecurityAnswerLabel => 'إجابتك';

  @override
  String get privateModeSecurityQuestionCustomOption => 'كتابة سؤالي الخاص…';

  @override
  String get privateModeChooseSecurityQuestion => 'اختر سؤال أمان';

  @override
  String get privateModeSecurityAnswerEmpty => 'لا يمكن أن تكون الإجابة فارغة';

  @override
  String get privateModeIveSavedThis => 'لقد حفظت رمز النسخ الاحتياطي هذا';

  @override
  String get privateModeRecoveryOptionsTitle => 'خيارات الاسترداد';

  @override
  String get privateModeRecoveryOptionsDescription =>
      'إعادة إنشاء رمز النسخ الاحتياطي وسؤال الأمان دون تغيير كلمة المرور الخاصة بك.';

  @override
  String get privateModeRegenerateRecoveryAction => 'إعادة إنشاء';

  @override
  String get privateModeQuestionPetName => 'ما هو اسم حيوانك الأليف الأول؟';

  @override
  String get privateModeQuestionBirthCity => 'في أي مدينة ولدت؟';

  @override
  String get privateModeQuestionFirstSchool => 'ما هو اسم مدرستك الأولى؟';
  ...
  @override
  String get privateModeQuestionFavoriteBook => 'ما هو كتابك المفضل؟';

  @override
  String get privateModeNotSetUpDescription =>
      'قم بإعداد الوضع الخاص في الإعدادات لإبعاد التطبيقات والمواقع الحساسة عن العرض اليومي.';

  @override
  String get privateModeGoToSettingsAction => 'الانتقال إلى الإعدادات';

  @override
  String get privateModeLockedDescription =>
      'قم بإلغاء القفل لعرض تطبيقاتك ومواقعك الخاصة.';

  @override
  String get privateModeUnlockedDescription =>
      'التطبيقات والمواقع التي حددتها كخاصة.';

  @override
  String get privateModeNoItemsDescription =>
      'لم يتم تتبع أي تطبيقات أو مواقع خاصة بعد. حدد عنصرًا كخاص من تفاصيله لرؤيته هنا.';

  @override
  String get privateModeItemsCount => 'العناصر الخاصة';

  @override
  String get permissionBannerNotificationsDisabled => 'الإشعارات معطلة';

  @override
  String get permissionBannerSystemDesc =>
      'قم بتمكين الإشعارات في إعدادات النظام لتلقي تنبيهات جلسة التركيز.';

  @override
  String get permissionBannerOpenSystemSettings => 'فتح إعدادات النظام';

  @override
  String get permissionBannerAppDesc =>
      'قم بتمكين الإشعارات في إعدادات التطبيق لتلقي تنبيهات جلسة التركيز.';

  @override
  String get permissionBannerFocusDisabled => 'إشعارات التركيز معطلة';

  @override
  String get permissionBannerFocusDesc =>
      'قم بتمكين إشعارات وضع التركيز في الإعدادات لتلقي تنبيهات الجلسة.';

  @override
  String get topWebsites => 'أهم المواقع';

  @override
  String get noWebsitesTrackedYet => 'لم يتم تتبع أي مواقع بعد';

  @override
  String get browserDetailBlockedTooltip =>
      'تم الوصول إلى الحد اليومي – الموقع محظور';

  @override
  String get browserDetailTimeToday => 'الوقت اليوم';

  @override
  String get browserDetailVisitsToday => 'الزيارات اليوم';

  @override
  String get browserDetailDailyLimit => 'الحد اليومي';

  @override
  String get browserChartLegendTime => 'الوقت';

  @override
  String get browserChartLegendVisits => 'الزيارات';

  @override
  String get blockingBehaviorTitle => 'سلوك الحظر';

  @override
  String get blockingBehaviorNotificationOnlyTitle => 'إشعار فقط';

  @override
  String get blockingBehaviorNotificationOnlySubtitle =>
      'تنبيهك عند الوصول إلى الحد، دون أي إجراء آخر.';

  @override
  String get blockingBehaviorSoftBlockTitle => 'حظر مرن';

  @override
  String get blockingBehaviorSoftBlockSubtitle =>
      'إحضار Scolect إلى الواجهة مع خيارات للتصغير أو الإغلاق أو الغفوة أو إلغاء حظر التطبيق.';

  @override
  String get blockingBehaviorHardBlockTitle => 'حظر صارم';

  @override
  String get blockingBehaviorHardBlockSubtitle =>
      'مثل الحظر المرن، ويخفي التطبيق أيضًا فورًا من شاشتك.';

  @override
  String get blockingBehaviorNudgeNote =>
      'ملاحظة: الحظر هو تذكير لطيف، وليس قفلًا دائمًا. لا يزال بإمكانك إعادة فتح التطبيق من شريط المهام.';

  @override
  String get aboutUpdateChecking => 'جارٍ الفحص...';

  @override
  String get aboutUpdateCheckButton => 'التحقق من التحديثات';

  @override
  String get aboutUpdateCheckingProgress => 'جارٍ البحث عن تحديثات...';

  @override
  String get aboutUpdateUpToDate => 'أنت تستخدم أحدث إصدار';

  @override
  String get aboutUpdateFailed => 'تعذر التحقق من وجود تحديثات';

  @override
  String get aboutUpdateRetryPrompt =>
      'اضغط على \"التحقق من التحديثات\" للمحاولة مرة أخرى';

  @override
  String get aboutUpdateScheduled => 'تمت جدولة فحص التحديثات';

  @override
  String get aboutOpenSettingsFailed => 'فشل في فتح إعدادات النظام';

  @override
  String get onboardingWelcomeTitle => 'مرحبًا بك في Scolect';

  @override
  String get onboardingWelcomeDesc =>
      'تحكم في وقتك. يعمل Scolect بصمت في الخلفية — يتتبع كل تطبيق، وكل جلسة، وكل دقيقة.';

  @override
  String get onboardingEveryAppTitle => 'كل تطبيق، تلقائيًا';

  @override
  String get onboardingEveryAppDesc =>
      'يراقب Scolect التطبيق النشط ويسجل بهدوء المدة التي تقضيها في كل تطبيق — دون الحاجة لتشغيل مؤقتات أو تذكر أي شيء.';

  @override
  String get onboardingSeeTimeTitle => 'شاهد أين يذهب وقتك';

  @override
  String get onboardingSeeTimeDesc =>
      'تقارير يومية وأسبوعية رائعة توضح التطبيقات الأكثر استخدامًا، وإجمالي وقت الشاشة، واتجاهات الاستخدام بنظرة سريعة.';

  @override
  String get onboardingSmartLimitsTitle => 'حدود وتنبيهات ذكية';

  @override
  String get onboardingSmartLimitsDesc =>
      'عيّن حدودًا زمنية يومية لكل تطبيق أو لإجمالي وقت الشاشة. احصل على إشعار قبل الوصول إلى حدودك — وليس بعدها.';

  @override
  String get onboardingDeepFocusTitle => 'وضع التركيز العميق';

  @override
  String get onboardingDeepFocusDesc =>
      'احظر التطبيقات المشتتة للانتباه أثناء جلسات بومودورو. فترات عمل واستراحة مخصصة مع أصوات محيطية اختيارية تبقيك في حالة تركيز.';

  @override
  String get onboardingTrackBrowserTitle => 'تتبع وقت التصفح أيضًا';

  @override
  String get onboardingTrackBrowserDesc =>
      'قم بتثبيت إضافة المتصفح المجانية لتتبع الوقت المستغرق في المواقع — وليس التطبيقات فقط. صورة متكاملة في لوحة تحكم واحدة.';

  @override
  String get onboardingAllSetTitle => 'أنت جاهز تمامًا';

  @override
  String get onboardingAllSetDesc =>
      'Scolect جاهز للبدء. تبقى بياناتك بالكامل على جهازك — خاصة تمامًا، ولا يتم رفعها إلى أي مكان.';
  ...
  @override
  String get onboardingGoToDashboard => 'الذهاب إلى لوحة التحكم';

  @override
  String get onboardingWorksInBrowserTitle => 'يعمل مباشرة في متصفحك';

  @override
  String get onboardingWorksInBrowserDesc =>
      'تتبع نشاط الويب تلقائيًا أثناء التصفح. لا يتطلب تشغيل تطبيق سطح المكتب للبدء.';

  @override
  String get onboardingUsageRightHereTitle => 'استخدامك، هنا مباشرة';

  @override
  String get onboardingUsageRightHereDesc =>
      'عرض تقارير يومية وأسبوعية مفصلة عن الوقت المستغرق في كل موقع من خلال مخططات بيانية نظيفة وسهلة الفهم.';

  @override
  String get onboardingSyncWithDesktopTitle => 'المزامنة مع تطبيق سطح المكتب';

  @override
  String get onboardingSyncWithDesktopDesc =>
      'اتصل بسلاسة مع تطبيق Scolect لسطح المكتب للحصول على تحليلات مجمعة للتطبيقات الأصلية ومواقع الويب.';

  @override
  String get onboarding100PrivateTitle => 'خصوصية 100%';

  @override
  String get onboarding100PrivateDesc =>
      'يتم تخزين جميع بيانات التتبع محليًا في متصفحك وعلى جهازك. لا يتم إرسال أي شيء إلى السحابة مطلقًا.';
